...
Kube-Knark is an open source audit tracer (via ebpf technilogy) who perform run time on a deployed kubernetes cluster looking for malware code execution.
